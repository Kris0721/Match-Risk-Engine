#[cfg(feature = "loom")]
use loom::sync::atomic::{fence, AtomicBool, AtomicI64, AtomicU32, AtomicU64, Ordering};
...
impl AccountRiskState {
    const PAYLOAD_SIZE: usize = std::mem::size_of::<u64>()   // seq
...
impl AccountRiskStateWriter {
    pub fn new(inner: AccountRiskState) -> Self {
        Self { inner }
    }
    ...
    pub fn inner(&self) -> &AccountRiskState {
        &self.inner
    }
}
